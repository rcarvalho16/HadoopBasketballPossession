...
- Ball in-air or unknown possession times.

Below is an example of the output generated by the project, as seen in `ExampleOutput.txt`:

| Team               | Possession Time (seconds) |
|--------------------|--------------------------|
| **Lakers (Yellow)** | 5                        |
| **Trailblazers (Red)** | 25                     |
| **Unknown Team**    | 20                       |
